...
public class InterfaceJeu extends JFrame {
    ...
    public InterfaceJeu(final Game game) {
        ...
        JLabel lblPlayer1 = this.createLabelForPlayerName();
        ...
        btnDeckCard.setToolTipText("60 cards remaining");
        ...
        layeredThurnplan.add(panel);
        
        this.setSize(1600, 900);
        this.setVisible(true);
    }
    
    private JLabel createLabelForPlayerName() {
